...
## DEEP ?
$PlistBuddy -c "Set :com.apple.developer.team-identifier XXX" Root.entitlements
$PlistBuddy -c "Set :com.apple.application-identifier XXX.x.x.x" Root.entitlements
$PlistBuddy -c "Set :com.apple.security.application-groups:0 XXX.x.x.x" Root.entitlements
